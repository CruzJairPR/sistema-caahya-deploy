...
export default function RecursosRevisionPrimerPeriodoPage() {
  ...
  const {
    ...
    handleEliminar,
    resetForm,
  } = useRevisadoraMedia("recursosRevisionPrimerPeriodo");
  ...
  const handleGuardar = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    if (esSoloConsulta) return;
    await handleSubmit();
    // Cerramos el modal tras la ejecución
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#f5f5f5" }}>
      ...
      >
        <BannerInstitucional titulo="Recursos de Revisión - Primer Periodo" />
      ...
      {!esSoloConsulta && (
        ...
        >
          ...
          >
            {editandoId ? "Editar Recurso" : "Subir Recurso - Primer Periodo"}
            <IconButton
