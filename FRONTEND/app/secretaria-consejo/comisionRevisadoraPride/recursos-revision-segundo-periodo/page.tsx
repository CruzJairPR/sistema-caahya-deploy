...
export default function RecursosRevisionSegundoPeriodoPage() {
  ...
  // Reutilizamos el hook apuntando al endpoint de segundo periodo
  const {
    titulo,
    setTitulo,
    descripcion,
    ...
    handleEliminar,
    resetForm,
  } = useRevisadoraMedia("recursosRevisionSegundoPeriodo");
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#f5f5f5" }}>
      ...
      >
        <BannerInstitucional titulo="Recursos de Revisión - Segundo Periodo" />
