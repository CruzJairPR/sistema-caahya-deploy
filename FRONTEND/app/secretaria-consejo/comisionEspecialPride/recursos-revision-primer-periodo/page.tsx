...
export default function ComisionEspecialRecursosPrimerPeriodoPage() {
  ...
  const {
    ...
    handleEliminar,
    resetForm,
  } = useRevisadoraMedia("comisionEspecialRecursosPrimerPeriodo");
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#f5f5f5" }}>
      ...
      >
        <BannerInstitucional titulo="Recursos de Revisión - Primer Periodo (Comisión Especial)" />
