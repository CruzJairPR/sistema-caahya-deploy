...
export default function ComisionEspecialRecursosSegundoPeriodoPage() {
  ...
  // Apuntamos al endpoint exclusivo para los recursos de segundo periodo de la comisión especial
  const {
    titulo,
    setTitulo,
    descripcion,
    ...
    handleEliminar,
    resetForm,
  } = useRevisadoraMedia("comisionEspecialRecursosSegundoPeriodo");
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#f5f5f5" }}>
      ...
      >
        <BannerInstitucional titulo="Recursos de Revisión - Segundo Periodo (Comisión Especial)" />
        ...
        >
          ...
          {cargando ? (
            ...
            <MediaTable
              ...
              labelColumnaArchivo="Documento de Recurso"
      ...
      {!esSoloConsulta && (
        ...
        >
          ...
          >
            {editandoId ? "Editar Recurso" : "Subir Recurso - Segundo Periodo"}
            <IconButton
