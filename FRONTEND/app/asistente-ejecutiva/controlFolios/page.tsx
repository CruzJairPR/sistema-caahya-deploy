...
export default function FoliosPage() {
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#f5f5f5", pb: 5 }}>
      ...
      >
        <BannerInstitucional titulo="FOLIOS" />
        ...
        >
          {cargando ? (
            ...
            <MediaTable
              ...
              fileIcon={<AssignmentIcon sx={{ color: "#1f4e79" }} />}
              labelColumnaArchivo="Folio"
      ...
      {!esSoloConsulta && (
        ...
        >
          ...
          >
            {idEditando ? "Editar Folio" : "Subir Nuevo Folio"}
            <IconButton
              aria-label="close"
              onClick={() => {
                setModalAbierto(false);
          ...
          <Box component="form" onSubmit={handleGuardarFolio}>
            <DialogContent dividers sx={{ p: 3 }}>
              <Stack spacing={3}>
                <TextField
                  label="Título del Folio"
                  variant="outlined"
                  fullWidth
                  value={titulo}
